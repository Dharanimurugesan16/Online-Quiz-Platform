...
//          .filter(attempt => attempt.score !== null && attempt.quizId)
//          .map(attempt => Number(attempt.quizId));
//        setCompletedQuizIds([...new Set(completedIds)]);
//        console.log("Completed quiz IDs:", completedIds);
//
...
//          quiz => quiz.id && (!completedIds.includes(quiz.id) || approvedRetakes.includes(quiz.id))
//        );
