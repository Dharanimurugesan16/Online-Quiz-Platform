...
export default function ResultPage() {
  ...
  const { quiz, answers, score, attemptId, timeSpent } = location.state || {};
    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center p-4 bg-fuchsia-50 rounded-2xl">
                ...
                <div className="text-2xl font-bold text-fuchsia-700">{Math.round(timeSpent / 60)}:{(timeSpent % 60).toString().padStart(2, "0")}</div>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <button
            onClick={() => handleNavigate(`/review/${attemptId}`)}
            className="flex items-center space-x-2 px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-xl font-semibold hover:from-blue-600 hover:to-indigo-600 transform hover:scale-105 transition-all duration-200 shadow-lg"
          >
          ...
          <button
            ...
            className="flex items-center space-x-2 px-8 py-4 bg-white text-gray-700 border-2 border-gray-300 rounded-xl font-semibold hover:bg-gray-200 hover:border-gray-400 transform hover:scale-105 transition-all duration-200"
          >
